...
StringBuilder sb2 = new StringBuilder("Hola Mundo"); // Constructor con una cadena inicial
StringBuilder sb3 = new StringBuilder(50); // Constructor con capacidad inicial (50 caracteres)

// Métodos de StringBuilder

// Append: Agregar texto al final del StringBuilder
...
sb2.reverse(); // Invierte el contenido del StringBuilder
System.out.println(sb2); // Salida: "odnuM oísdA"

// Capacidad: Capacidad interna del StringBuilder
...
String str = sb2.toString(); // Convierte el StringBuilder a un objeto String
...
sb1.ensureCapacity(100); // Asegura que el StringBuilder tenga al menos la capacidad especificada (100)
...
// Convertir un array de caracteres a StringBuilder
char[] charArray = {'H', 'o', 'l', 'a'};
StringBuilder sbFromArray = new StringBuilder(new String(charArray)); // Convertir un char[] a StringBuilder
