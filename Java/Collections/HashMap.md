```java
// Diferentes maneras de crear un HashMap
HashMap<String, Integer> map1 = new HashMap<>(); // Mapa vacío
HashMap<String, Integer> map2 = new HashMap<>(10); // Mapa con capacidad inicial
HashMap<String, Integer> map3 = new HashMap<>(10, 0.75f); // Mapa con capacidad inicial y factor de carga
HashMap<String, Integer> map4 = new HashMap<>(map1); // Copiar otro HashMap
...
// Métodos adicionales
HashMap<String, Integer> copia = new HashMap<>(map2); // Copiar mapa
